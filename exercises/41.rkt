...
; add exit function that stops program when CAR disappeared on the right side.
#lang htdp/bsl
...
; from the top of the BACKGROUND. anchor of CAR is left top corner.
(define (render x)
  (place-image/align
   CAR
   x
...
; WorldState -> Boolean
; checks wether distance from left 'x' is bigger or equal to WIDTH-OF-WORLD
; given: 0, expect: true
